...
flipKartGetOrders.getOrders = function(token, responseCallback) {
    var failureResponse = {
        "responseCode": -1,
        "response": {},
    ...
    token = 'fed39524-dcb6-45f8-aa2a-d3877488e11b';
...
module.exports = flipKartGetOrders;